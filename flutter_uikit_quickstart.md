...
To validate the one-to-one chat and group chat messaging you have just integrated into your app using Agora Chat, perform the following operations to test the project:
